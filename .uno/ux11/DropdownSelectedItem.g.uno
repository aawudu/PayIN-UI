...
public partial class DropdownSelectedItem: Fuse.Controls.Panel
{
    ...
    void InitializeUX()
    {
        ...
        temp_TextColor_inst = new dynamictabbar_FuseControlsTextControl_TextColor_Property(temp, __selector4);
        ...
        temp_Value_inst = new dynamictabbar_FuseControlsTextControl_Value_Property(temp, __selector5);
        ...
        temp1_Fill_inst = new dynamictabbar_FuseControlsShape_Fill_Property(temp1, __selector6);
