...
public partial class DropdownSelectedItem: Fuse.Controls.Panel
{
    ...
    void InitializeUX()
    {
        ...
        temp_FontSize_inst = new payinui_FuseControlsTextControl_FontSize_Property(temp, __selector0);
        var temp3 = new global::Fuse.Reactive.Property(temp2, payinui_accessor_DropdownSelectedItem_FontSize.Singleton);
        this_Text_inst = new payinui_DropdownSelectedItem_Text_Property(this, __selector1);
        this_BackgroundColor_inst = new payinui_DropdownSelectedItem_BackgroundColor_Property(this, __selector2);
        this_BorderColor_inst = new payinui_DropdownSelectedItem_BorderColor_Property(this, __selector3);
        this_FontSize_inst = new payinui_DropdownSelectedItem_FontSize_Property(this, __selector0);
        this_TextColor_inst = new payinui_DropdownSelectedItem_TextColor_Property(this, __selector4);
        __g_nametable = new global::Uno.UX.NameTable(null, __g_static_nametable);
        var temp4 = new global::Fuse.Reactive.Constant(this);
        temp_TextColor_inst = new payinui_FuseControlsTextControl_TextColor_Property(temp, __selector4);
        var temp5 = new global::Fuse.Reactive.Property(temp4, payinui_accessor_DropdownSelectedItem_TextColor.Singleton);
        var temp6 = new global::Fuse.Reactive.Constant(this);
        temp_Value_inst = new payinui_FuseControlsTextControl_Value_Property(temp, __selector5);
        var temp7 = new global::Fuse.Reactive.Property(temp6, payinui_accessor_DropdownSelectedItem_Text.Singleton);
        var temp8 = new global::Fuse.Reactive.Constant(this);
        var temp1 = new global::Fuse.Controls.Rectangle();
        temp1_Fill_inst = new payinui_FuseControlsShape_Fill_Property(temp1, __selector6);
        var temp9 = new global::Fuse.Reactive.Property(temp8, payinui_accessor_DropdownSelectedItem_BackgroundColor.Singleton);
