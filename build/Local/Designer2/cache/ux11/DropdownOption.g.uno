...
public partial class DropdownOption: Fuse.Controls.Panel
{
    ...
    void InitializeUX()
    {
        ...
        bgCol_Fill_inst = new dynamictabbar_FuseControlsShape_Fill_Property(bgCol, __selector0);
        var temp4 = new global::Fuse.Reactive.Property(temp3, dynamictabbar_accessor_DropdownOption_BackgroundColor.Singleton);
        this_Text_inst = new dynamictabbar_DropdownOption_Text_Property(this, __selector1);
        this_BackgroundColor_inst = new dynamictabbar_DropdownOption_BackgroundColor_Property(this, __selector2);
        this_BorderColor_inst = new dynamictabbar_DropdownOption_BorderColor_Property(this, __selector3);
        this_FontSize_inst = new dynamictabbar_DropdownOption_FontSize_Property(this, __selector4);
        this_TextColor_inst = new dynamictabbar_DropdownOption_TextColor_Property(this, __selector5);
        __g_nametable = new global::Uno.UX.NameTable(null, __g_static_nametable);
        var temp = new global::Fuse.Drawing.Stroke();
        temp_Brush_inst = new dynamictabbar_FuseDrawingStroke_Brush_Property(temp, __selector6);
        var temp5 = new global::Fuse.Reactive.Property(temp2, dynamictabbar_accessor_DropdownOption_BorderColor.Singleton);
        var temp6 = new global::Fuse.Reactive.Constant(this);
        var temp1 = new global::Fuse.Controls.Text();
        temp1_Value_inst = new dynamictabbar_FuseControlsTextControl_Value_Property(temp1, __selector7);
        var temp7 = new global::Fuse.Reactive.Property(temp6, dynamictabbar_accessor_DropdownOption_Text.Singleton);
        var temp8 = new global::Fuse.Reactive.Constant(this);
        temp1_FontSize_inst = new dynamictabbar_FuseControlsTextControl_FontSize_Property(temp1, __selector4);
        var temp9 = new global::Fuse.Reactive.Property(temp8, dynamictabbar_accessor_DropdownOption_FontSize.Singleton);
        var temp10 = new global::Fuse.Reactive.Constant(this);
        temp1_Color_inst = new dynamictabbar_FuseControlsTextControl_Color_Property(temp1, __selector8);
        var temp11 = new global::Fuse.Reactive.Property(temp10, dynamictabbar_accessor_DropdownOption_TextColor.Singleton);
        var temp12 = new global::Fuse.Reactive.DataBinding(bgCol_Fill_inst, temp4, __g_nametable, Fuse.Reactive.BindingMode.Read);
        var temp13 = new global::Fuse.Reactive.DataBinding(temp_Brush_inst, temp5, __g_nametable, Fuse.Reactive.BindingMode.Read);
        var temp14 = new global::Fuse.Reactive.DataBinding(temp1_Value_inst, temp7, __g_nametable, Fuse.Reactive.BindingMode.Read);
        var temp15 = new global::Fuse.Reactive.DataBinding(temp1_FontSize_inst, temp9, __g_nametable, Fuse.Reactive.BindingMode.Read);
        var temp16 = new global::Fuse.Reactive.DataBinding(temp1_Color_inst, temp11, __g_nametable, Fuse.Reactive.BindingMode.Read);
        this.Height = new Uno.UX.Size(40f, Uno.UX.Unit.Unspecified);
        this.Name = __selector9;
        bgCol.Layer = Fuse.Layer.Background;
        bgCol.Name = __selector10;
    ...
    static global::Uno.UX.Selector __selector9 = "self";
    static global::Uno.UX.Selector __selector10 = "bgCol";
}
