...
{
    return static_cast<void>(*__retval = 0LL), void();
}
...
void NetworkStream__Read_fn(NetworkStream* __this, uArray* dst, int* byteOffset, int* byteCount, int* __retval)
{
    ...
    return static_cast<void>(*__retval = uPtr(__this->_socket)->Receive1(dst, byteOffset_, byteCount_, 0)), void();
}
...
// public bool Poll(int milliseconds, Uno.Net.Sockets.SelectMode mode) :1050
...
// public void Shutdown(Uno.Net.Sockets.SocketShutdown how) :1063
...
// public void Close() [instance] :1092
void Socket::Close()
{
...
// public bool Poll(int milliseconds, Uno.Net.Sockets.SelectMode mode) [instance] :1050
...
// public void Shutdown(Uno.Net.Sockets.SocketShutdown how) [instance] :1063
