...
// public void SetHeader(string key, string value) :82
...
{
    uStackFrame __("Jetfire.WebSocketClient", "HandleEvent(string,string)");
...
// public void SetHeader(string key, string value) [instance] :82
