...
{
    uStackFrame __("dynamictabbar_accessor_DropdownOption_BorderColor", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("dynamictabbar_accessor_DropdownOption_BorderColor", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
