...
// internal sealed class dynamictabbar_DropdownOption_BackgroundColor_Property :347
// {
...
// public dynamictabbar_DropdownOption_BackgroundColor_Property(DropdownOption obj, Uno.UX.Selector name) :350
...
// public override sealed Fuse.Drawing.Brush Get(Uno.UX.PropertyObject obj) :352
...
{
    uStackFrame __("dynamictabbar_DropdownOption_BackgroundColor_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::DropdownOption*>(obj, ::TYPES[0/*DropdownOption*/]))->BackgroundColor(), void();
}

// public dynamictabbar_DropdownOption_BackgroundColor_Property New(DropdownOption obj, Uno.UX.Selector name) :350
...
// public override sealed void Set(Uno.UX.PropertyObject obj, Fuse.Drawing.Brush v, Uno.UX.IPropertyListener origin) :353
...
{
    uStackFrame __("dynamictabbar_DropdownOption_BackgroundColor_Property", "Set(Uno.UX.PropertyObject,Fuse.Drawing.Brush,Uno.UX.IPropertyListener)");
...
// public dynamictabbar_DropdownOption_BackgroundColor_Property(DropdownOption obj, Uno.UX.Selector name) [instance] :350
...
// public dynamictabbar_DropdownOption_BackgroundColor_Property New(DropdownOption obj, Uno.UX.Selector name) [static] :350
