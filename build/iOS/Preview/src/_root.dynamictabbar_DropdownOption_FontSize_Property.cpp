...
// internal sealed class dynamictabbar_DropdownOption_FontSize_Property :320
// {
...
// public dynamictabbar_DropdownOption_FontSize_Property(DropdownOption obj, Uno.UX.Selector name) :323
...
// public override sealed float Get(Uno.UX.PropertyObject obj) :325
...
{
    uStackFrame __("dynamictabbar_DropdownOption_FontSize_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::DropdownOption*>(obj, ::TYPES[0/*DropdownOption*/]))->FontSize(), void();
}

// public dynamictabbar_DropdownOption_FontSize_Property New(DropdownOption obj, Uno.UX.Selector name) :323
...
// public override sealed void Set(Uno.UX.PropertyObject obj, float v, Uno.UX.IPropertyListener origin) :326
...
{
    uStackFrame __("dynamictabbar_DropdownOption_FontSize_Property", "Set(Uno.UX.PropertyObject,float,Uno.UX.IPropertyListener)");
    float v_ = *v;
...
// public dynamictabbar_DropdownOption_FontSize_Property(DropdownOption obj, Uno.UX.Selector name) [instance] :323
...
// public dynamictabbar_DropdownOption_FontSize_Property New(DropdownOption obj, Uno.UX.Selector name) [static] :323
