...
// internal sealed class dynamictabbar_FuseControlsImage_Url_Property :373
// {
...
// public dynamictabbar_FuseControlsImage_Url_Property(Fuse.Controls.Image obj, Uno.UX.Selector name) :376
...
// public override sealed string Get(Uno.UX.PropertyObject obj) :378
...
{
    uStackFrame __("dynamictabbar_FuseControlsImage_Url_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Controls::Image*>(obj, ::TYPES[0/*Fuse.Controls.Image*/]))->Url(), void();
}

// public dynamictabbar_FuseControlsImage_Url_Property New(Fuse.Controls.Image obj, Uno.UX.Selector name) :376
...
// public override sealed Uno.UX.PropertyObject get_Object() :377
...
// public override sealed void Set(Uno.UX.PropertyObject obj, string v, Uno.UX.IPropertyListener origin) :379
...
{
    uStackFrame __("dynamictabbar_FuseControlsImage_Url_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
    uPtr(uCast< ::g::Fuse::Controls::Image*>(obj, ::TYPES[0/*Fuse.Controls.Image*/]))->Url(v);
}

// public dynamictabbar_FuseControlsImage_Url_Property(Fuse.Controls.Image obj, Uno.UX.Selector name) [instance] :376
...
// public dynamictabbar_FuseControlsImage_Url_Property New(Fuse.Controls.Image obj, Uno.UX.Selector name) [static] :376
