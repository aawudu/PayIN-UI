...
// internal sealed class dynamictabbar_FuseLayoutsColumn_Width_Property :200
// {
...
// public dynamictabbar_FuseLayoutsColumn_Width_Property(Fuse.Layouts.Column obj, Uno.UX.Selector name) :203
...
{
    uStackFrame __("dynamictabbar_FuseLayoutsColumn_Width_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Layouts::Column*>(obj, ::TYPES[0/*Fuse.Layouts.Column*/]))->Width(), void();
}

// public dynamictabbar_FuseLayoutsColumn_Width_Property New(Fuse.Layouts.Column obj, Uno.UX.Selector name) :203
...
{
    uStackFrame __("dynamictabbar_FuseLayoutsColumn_Width_Property", "Set(Uno.UX.PropertyObject,float,Uno.UX.IPropertyListener)");
    float v_ = *v;
    uPtr(uCast< ::g::Fuse::Layouts::Column*>(obj, ::TYPES[0/*Fuse.Layouts.Column*/]))->Width(v_);
}

// public dynamictabbar_FuseLayoutsColumn_Width_Property(Fuse.Layouts.Column obj, Uno.UX.Selector name) [instance] :203
...
// public dynamictabbar_FuseLayoutsColumn_Width_Property New(Fuse.Layouts.Column obj, Uno.UX.Selector name) [static] :203
