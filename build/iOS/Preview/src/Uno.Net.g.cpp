...
// private static extern Uno.Net.IPAddress[] GetLocalAddresses() :20
...
// private static extern Uno.Net.IPAddress[] GetLocalAddresses() [static] :20
...
static void IPAddress_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[0/*byte[]*/], offsetof(::g::Uno::Net::IPAddress, _address), 0,
...
void IPAddress__Equals_fn(IPAddress* __this, uObject* obj, bool* __retval)
{
    ...
    if (ip == NULL)
        return static_cast<void>(*__retval = false), void();
    ...
    return static_cast<void>(*__retval = true), void();
}
...
void IPAddress__GetHashCode_fn(IPAddress* __this, int* __retval)
{
    ...
    int ind4;
    int hash = 629 + ::g::Uno::Int::GetHashCode((static_cast<void>(ind4 = __this->_addressFamily), ind4), ::TYPES[1/*int*/]);
    ...
    return static_cast<void>(*__retval = hash), void();
}
...
void IPAddress__ToString_fn(IPAddress* __this, uString** __retval)
{
    ...
    switch (__this->AddressFamily())
    {
        ...
        case 23:
        {
            ...
            return static_cast<void>(*__retval = ret), void();
        }
        default:
...
void IPEndPoint__ToString_fn(IPEndPoint* __this, uString** __retval)
{
    ...
    return static_cast<void>(*__retval = ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(uPtr(__this->Address())->ToString(), ::STRINGS[11/*":"*/]), uBox<int>(::TYPES[1/*int*/], __this->Port()))), void();
}
