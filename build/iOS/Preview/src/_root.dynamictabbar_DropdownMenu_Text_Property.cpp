...
// public dynamictabbar_DropdownMenu_Text_Property(DropdownMenu obj, Uno.UX.Selector name) :393
...
{
    uStackFrame __("dynamictabbar_DropdownMenu_Text_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::DropdownMenu*>(obj, ::TYPES[0/*DropdownMenu*/]))->Text(), void();
}

// public dynamictabbar_DropdownMenu_Text_Property New(DropdownMenu obj, Uno.UX.Selector name) :393
...
{
    *__retval = dynamictabbar_DropdownMenu_Text_Property::New1(obj, *name);
}
...
{
    uStackFrame __("dynamictabbar_DropdownMenu_Text_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
...
// public dynamictabbar_DropdownMenu_Text_Property(DropdownMenu obj, Uno.UX.Selector name) [instance] :393
void dynamictabbar_DropdownMenu_Text_Property::ctor_3(::g::DropdownMenu* obj, ::g::Uno::UX::Selector name)
{
    ctor_2(name);
    _obj = obj;
}

// public dynamictabbar_DropdownMenu_Text_Property New(DropdownMenu obj, Uno.UX.Selector name) [static] :393
dynamictabbar_DropdownMenu_Text_Property* dynamictabbar_DropdownMenu_Text_Property::New1(::g::DropdownMenu* obj, ::g::Uno::UX::Selector name)
{
    dynamictabbar_DropdownMenu_Text_Property* obj1 = (dynamictabbar_DropdownMenu_Text_Property*)uNew(dynamictabbar_DropdownMenu_Text_Property_typeof());
