...
// internal sealed class dynamictabbar_FuseAnimationsAttractorfloat4_Value_Property :183
// {
...
// public dynamictabbar_FuseAnimationsAttractorfloat4_Value_Property(Fuse.Animations.Attractor<float4> obj, Uno.UX.Selector name) :186
...
{
    uStackFrame __("dynamictabbar_FuseAnimationsAttractorfloat4_Value_Property", "Get(Uno.UX.PropertyObject)");
    ::g::Uno::Float4 ret2;
...
// public dynamictabbar_FuseAnimationsAttractorfloat4_Value_Property New(Fuse.Animations.Attractor<float4> obj, Uno.UX.Selector name) :186
...
{
    uStackFrame __("dynamictabbar_FuseAnimationsAttractorfloat4_Value_Property", "Set(Uno.UX.PropertyObject,float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
...
// public dynamictabbar_FuseAnimationsAttractorfloat4_Value_Property(Fuse.Animations.Attractor<float4> obj, Uno.UX.Selector name) [instance] :186
...
// public dynamictabbar_FuseAnimationsAttractorfloat4_Value_Property New(Fuse.Animations.Attractor<float4> obj, Uno.UX.Selector name) [static] :186
