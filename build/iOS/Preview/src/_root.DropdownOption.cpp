// This file was generated based on /Users/phoenix/Fuse/app_payin/dynamic-tab-bar/build/iOS/Preview/cache/ux11/DropdownOption.g.uno.
...
#include <_root.dynamictabbar_accessor_DropdownOption_FontSize.h>
#include <_root.dynamictabbar_accessor_DropdownOption_Text.h>
...
static void DropdownOption__cctor_4_fn(uType* __type)
{
    ...
    DropdownOption::__selector8_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[9/*"Color"*/]);
    DropdownOption::__selector9_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[10/*"self"*/]);
    DropdownOption::__selector10_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"bgCol"*/]);
}
...
static void DropdownOption_build(uType* type)
{
    ...
    type->SetFields(110,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL), offsetof(::g::DropdownOption, temp1_Color_inst), 0,
        ...
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::DropdownOption::__selector10_, uFieldFlagsStatic,
...
::g::Uno::UX::Selector DropdownOption::__selector10_;
...
void DropdownOption::InitializeUX()
{
    ...
    temp1_Color_inst = ::g::dynamictabbar_FuseControlsTextControl_Color_Property::New1(temp1, DropdownOption::__selector8());
    ...
    ::g::Fuse::Reactive::DataBinding* temp12 = ::g::Fuse::Reactive::DataBinding::New1(bgCol_Fill_inst, (uObject*)temp4, __g_nametable1, 1);
    ::g::Fuse::Reactive::DataBinding* temp13 = ::g::Fuse::Reactive::DataBinding::New1(temp_Brush_inst, (uObject*)temp5, __g_nametable1, 1);
    ::g::Fuse::Reactive::DataBinding* temp14 = ::g::Fuse::Reactive::DataBinding::New1(temp1_Value_inst, (uObject*)temp7, __g_nametable1, 1);
    ::g::Fuse::Reactive::DataBinding* temp15 = ::g::Fuse::Reactive::DataBinding::New1(temp1_FontSize_inst, (uObject*)temp9, __g_nametable1, 1);
    ::g::Fuse::Reactive::DataBinding* temp16 = ::g::Fuse::Reactive::DataBinding::New1(temp1_Color_inst, (uObject*)temp11, __g_nametable1, 1);
    Height(::g::Uno::UX::Size__New1(40.0f, 1));
    Name(DropdownOption::__selector9());
    uPtr(bgCol)->Layer(1);
    uPtr(bgCol)->Name(DropdownOption::__selector10());
    ...
    temp->Width(1.0f);
    temp1->Alignment(11);
    temp1->Margin(::g::Uno::Float4__New2(0.0f, 0.0f, 10.0f, 0.0f));
    temp1->Font(::g::Fuse::Font::Regular());
