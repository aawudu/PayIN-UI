...
struct DropdownSelectedItem : ::g::Fuse::Controls::DockPanel
{
    ...
    static ::g::Uno::UX::Selector& __selector8() { return DropdownSelectedItem_typeof()->Init(), __selector8_; }
    ...
    static DropdownSelectedItem* New5();
};
// }
