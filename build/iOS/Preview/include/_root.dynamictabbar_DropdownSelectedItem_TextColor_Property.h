...
namespace g{struct dynamictabbar_DropdownSelectedItem_TextColor_Property;}
...
struct dynamictabbar_DropdownSelectedItem_TextColor_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::DropdownSelectedItem*> _obj;

    void ctor_3(::g::DropdownSelectedItem* obj, ::g::Uno::UX::Selector name);
    static dynamictabbar_DropdownSelectedItem_TextColor_Property* New1(::g::DropdownSelectedItem* obj, ::g::Uno::UX::Selector name);
};
// }
