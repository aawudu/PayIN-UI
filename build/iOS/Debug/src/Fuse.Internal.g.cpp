...
static void FontFaceDescriptor_build(uType* type)
{
    ...
    ::TYPES[14] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(0/*All<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[15] = ::g::Uno::Predicate_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    type->SetFields(0,
        ::g::Uno::UX::FileSource_typeof(), offsetof(::g::Fuse::Internal::FontFaceDescriptor, FileSource), 0,
        ::TYPES[10/*int*/], offsetof(::g::Fuse::Internal::FontFaceDescriptor, Index), 0,
        ::TYPES[11/*Uno.Collections.IEnumerable<string>*/], offsetof(::g::Fuse::Internal::FontFaceDescriptor, Styles), 0);
}
...
void FontFaceDescriptor__GetHashCode_fn(FontFaceDescriptor* __this, int* __retval)
{
    ...
    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Styles), ::TYPES[11/*Uno.Collections.IEnumerable<string>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
    {
...
{
    return ::g::Uno::Collections::EnumerableExtensions::All(::TYPES[14/*Uno.Collections.EnumerableExtensions.All<string>*/], Styles, uDelegate::New(::TYPES[15/*Uno.Predicate<string>*/], (void*)::g::Uno::String__Contains_fn, uPtr(styleString)));
}
...
static void ImageContainer_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[29/*Uno.Collections.RootableList<Uno.UX.FileSource>*/], offsetof(::g::Fuse::Internal::ImageContainer, _files), 0,
        ...
        ::TYPES[18/*Fuse.Internal.IImageContainerOwner*/], offsetof(::g::Fuse::Internal::ImageContainer, _owner), uFieldFlagsWeak,
        ...
        ::TYPES[25/*Uno.EventHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, ParamChanged1), 0,
        ::TYPES[25/*Uno.EventHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, SourceChanged1), 0,
        ::TYPES[26/*Fuse.Resources.ImageSourceErrorHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, SourceError1), 0);
}
...
void ImageContainer::CreateMultiDensitySource()
{
    ...
    for (uObject* enum4 = (uObject*)uPtr(_files)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum4), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
    {
...
void ImageContainer::ReapplyOptions(::g::Fuse::Resources::ImageSource* src)
{
    ...
    if (mf != NULL)
        ...
        for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(mf)->Sources()), ::TYPES[23/*Uno.Collections.IEnumerable<Fuse.Resources.ImageSource>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
        {
...
static void MiniList_build(uType* type)
{
    ...
    ::TYPES[30] = MiniList__Enumerator_typeof();
    ::TYPES[31] = ::g::Fuse::Internal::ObjectList_typeof();
    type->SetPrecalc(
...
static void ObjectList_build(uType* type)
{
    ...
    ::TYPES[32] = ObjectList__EnumeratorClass_typeof();
    ::TYPES[6] = ObjectList__Enumerator_typeof();
    ::TYPES[33] = uObject_typeof()->Array();
    ::TYPES[34] = ObjectList__Node_typeof();
    type->SetPrecalc(
    ...
    type->SetFields(0,
        ...
        ::TYPES[34/*Fuse.Internal.ObjectList`1.Node*/]->MakeType(type->T(0), NULL)->Array(), offsetof(::g::Fuse::Internal::ObjectList, _nodes), 0,
