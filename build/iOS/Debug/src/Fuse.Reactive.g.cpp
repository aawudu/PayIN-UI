...
static void Instantiator_build(uType* type)
{
    ...
    ::TYPES[40] = ::g::Fuse::Node_typeof();
    ::TYPES[15] = ::g::Uno::Action_typeof();
    ::TYPES[52] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2/*IndexOf<Fuse.Node>*/, ::TYPES[40/*Fuse.Node*/], NULL);
    ::TYPES[3] = ::g::Uno::IDisposable_typeof();
...
{
    ::STRINGS[27] = uString::Const("'");
    ::STRINGS[67] = uString::Const("' does not contain property '");
    ::TYPES[54] = ::g::Fuse::IObject_typeof();
    type->SetInterfaces(
...
{
    __this->ClearDiagnostic();
    uObject* io = uAs<uObject*>(obj, ::TYPES[54/*Fuse.IObject*/]);

    if ((io != NULL) && ::g::Fuse::IObject::ContainsKey(uInterface(uPtr(io), ::TYPES[54/*Fuse.IObject*/]), uPtr(__this->_member)->Name()))
        __this->PushNewData(::g::Fuse::IObject::Item(uInterface(uPtr(io), ::TYPES[54/*Fuse.IObject*/]), uPtr(__this->_member)->Name()));
    else
        __this->SetDiagnostic(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[27/*"'"*/], ::g::Uno::Object::ToString(uPtr(uPtr(__this->_member)->Operand()))), ::STRINGS[67/*"' does not ...*/]), uPtr(__this->_member)->Name()), ::STRINGS[27/*"'"*/]), (uObject*)__this->_member);
}
...
{
    ::STRINGS[68] = uString::Const(" (ScriptMethod)");
...
void ThreadWorker__MethodClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Reactive::ThreadWorker* worker)
{
    _m = m;
    _worker = worker;
    ::g::Fuse::Scripting::Function* factory = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(uPtr(m)->Name, ::STRINGS[68/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[69/*"(function (...*/], uPtr(m)->Name), ::STRINGS[70/*" = function...*/])), ::TYPES[26/*Fuse.Scripting.Function*/]);
...
static void ModuleInstance_build(uType* type)
{
    ...
    ::STRINGS[72] = uString::Const("JavaScript error in ");
    ::STRINGS[73] = uString::Const(" fixed!");
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.JavaScript/1.2.1/$.uno");
    ::STRINGS[74] = uString::Const("EvaluateModule");
    ::STRINGS[75] = uString::Const("JavaScript error");
    ::TYPES[42] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
...
uObject* ModuleInstance::EvaluateExports()
{
    ...
    if (_moduleResult != NULL)
        return uPtr(uPtr(_moduleResult)->Object)->Item(::STRINGS[71/*"exports"*/]);
...
void ModuleInstance::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[72/*"JavaScript ...*/], uPtr(_js)->FileName()), ::STRINGS[73/*" fixed!"*/]), this, ::STRINGS[5/*"/usr/local/...*/], 669, ::STRINGS[74/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[75/*"JavaScript ...*/], se, this, ::STRINGS[5/*"/usr/local/...*/], 685, ::STRINGS[74/*"EvaluateMod...*/]);
...
{
    ::STRINGS[76] = uString::Const("Named object not found: ");
    ::TYPES[29] = ::g::Fuse::Reactive::IContext_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::ConstantExpression_type, interface0));
    type->SetFields(0,
...
void Name__GetValue_fn(Name* __this, uObject* context, uObject** __retval)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[76/*"Named objec...*/], __this->Identifier())));
}
...
static void ObjectMirror_build(uType* type)
{
    ...
    ::TYPES[5] = ::g::Fuse::Reactive::ValueMirror_typeof();
    ::TYPES[11] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[76] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    type->SetInterfaces(
...
{
    ::STRINGS[77] = uString::Const("addSubscriber");
    ::STRINGS[78] = uString::Const("set");
    ::STRINGS[79] = uString::Const("clear");
    ::STRINGS[80] = uString::Const("newAt");
    ::STRINGS[81] = uString::Const("newAll");
    ::STRINGS[82] = uString::Const("add");
    ::STRINGS[83] = uString::Const("removeAt");
    ::STRINGS[84] = uString::Const("insertAt");
    ::STRINGS[85] = uString::Const("removeRange");
    ::STRINGS[86] = uString::Const("insertAll");
    ::STRINGS[87] = uString::Const("failed");
    ::STRINGS[88] = uString::Const("Unhandled observable operation: ");
    ::STRINGS[89] = uString::Const("removeSubscriber");
    ::TYPES[57] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
...
void Observable::ctor_2(::g::Fuse::Reactive::ThreadWorker* worker, ::g::Fuse::Scripting::Object* obj, bool supressCallback)
{
    ...
    uPtr(obj)->CallMethod(::STRINGS[77/*"addSubscriber"*/], uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, (::g::Fuse::Scripting::Function*)_observeChange, uBox(::TYPES[24/*bool*/], supressCallback)));
}
...
uObject* Observable::ObserveChange(uArray* args)
{
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[81/*"newAll"*/]))
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[87/*"failed"*/]))
        uPtr(_worker)->Enqueue(Observable__Failed::New1(this, uAs<uString*>(uPtr(args)->Strong<uObject*>(3), ::TYPES[25/*string*/])));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[88/*"Unhandled o...*/], op)));
...
{
    uPtr(_observable)->CallMethod(::STRINGS[89/*"removeSubsc...*/], uArray::Init<uObject*>(::TYPES[4/*object[]*/], 1, (::g::Fuse::Scripting::Function*)_observeChange));
    _observeChange = NULL;
    _observable = NULL;
}
...
{
    ::STRINGS[90] = uString::Const("this._raw_");
    ::STRINGS[91] = uString::Const("this._");
    ::STRINGS[92] = uString::Const(" (ScriptProperty)");
    ::STRINGS[93] = uString::Const("(function(cl, getObservable) { Object.defineProperty(cl.prototype, '");
    ::STRINGS[94] = uString::Const("', ");
    ::STRINGS[28] = uString::Const("{");
    ::STRINGS[95] = uString::Const("get: function() { ");
    ::STRINGS[96] = uString::Const("var obs = getObservable(this); ");
    ::STRINGS[97] = uString::Const("if (");
    ::STRINGS[98] = uString::Const(" != obs) {");
    ::STRINGS[99] = uString::Const(" = obs;");
    ::STRINGS[100] = uString::Const(" = obs");
    ::STRINGS[101] = uString::Const(";");
    ::STRINGS[29] = uString::Const("}");
    ::STRINGS[102] = uString::Const("return ");
...
void ThreadWorker__PropertyClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptProperty* p, ::g::Fuse::Reactive::ThreadWorker* worker)
{
    _worker = worker;
    _p = p;
    uString* rawField = ::g::Uno::String::op_Addition2(::STRINGS[90/*"this._raw_"*/], uPtr(p)->Name);
    uString* propField = ::g::Uno::String::op_Addition2(::STRINGS[91/*"this._"*/], p->Name);
    ::g::Fuse::Scripting::Function* definer = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(p->Name, ::STRINGS[92/*" (ScriptPro...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[93/*"(function(c...*/], p->Name), ::STRINGS[94/*"', "*/]), ::STRINGS[28/*"{"*/]), ::STRINGS[95/*"get: functi...*/]), ::STRINGS[96/*"var obs = g...*/]), ::STRINGS[97/*"if ("*/]), rawField), ::STRINGS[98/*" != obs) {"*/]), rawField), ::STRINGS[99/*" = obs;"*/]), propField), ::STRINGS[100/*" = obs"*/]), p->Modifier), ::STRINGS[101/*";"*/]), ::STRINGS[29/*"}"*/]), ::STRINGS[102/*"return "*/]), propField), ::STRINGS[29/*"}"*/]), ::STRINGS[103/*"})"*/]), ::STRINGS[103/*"})"*/])), ::TYPES[26/*Fuse.Scripting.Function*/]);
...
{
    ::STRINGS[104] = uString::Const("{Resource ");
    ::STRINGS[40] = uString::Const("} not found in data context");
    ::TYPES[15] = ::g::Uno::Action_typeof();
    ::TYPES[3] = ::g::Uno::IDisposable_typeof();
...
void ResourceSubscription::OnChanged()
{
    ...
    if (uPtr(_origin)->TryGetResource(_key, uDelegate::New(::TYPES[81/*Uno.Predicate<object>*/], (void*)ResourceSubscription__Accept_fn, this), &resource))
        ...
        _diag = ::g::Fuse::Diagnostics::ReportTemporalUserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[104/*"{Resource "*/], _key), ::STRINGS[40/*"} not found...*/]), _origin);
}
...
void RootableScriptModule__GenerateArgs_fn(RootableScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uObject*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->Dependencies), &ret4), ret4); enum1.MoveNext(::TYPES[75/*Uno.Collections.Dictionary<string, object>.Enumerator*/]); )
    {
        ...
        argsString = ::g::Uno::String::op_Addition2(argsString, ::g::Uno::String::op_Addition2(::STRINGS[105/*", "*/], dep.Key(::TYPES[11/*Uno.Collections.KeyValuePair<string, object>*/])));
    ...
    while (nt != NULL)
    {
        ...
        {
            argsString = ::g::Uno::String::op_Addition2(argsString, ::g::Uno::String::op_Addition2(::STRINGS[105/*", "*/], uPtr(uPtr(nt)->Entries)->Strong<uString*>(i)));
...
static void UnaryOperator__Subscription_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::TYPES[6/*Fuse.Reactive.IListener*/], offsetof(UnaryOperator__Subscription_type, interface1));
    type->SetFields(2,
        ::TYPES[6/*Fuse.Reactive.IListener*/], offsetof(::g::Fuse::Reactive::UnaryOperator__Subscription, _listener), 0,
...
{
    ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[6/*Fuse.Reactive.IListener*/]), (uObject*)_uo, value);
}
...
{
    ::STRINGS[79] = uString::Const("clear");
    ::STRINGS[106] = uString::Const("replaceAllWithOrigin");
    ::STRINGS[107] = uString::Const("Unexpected null object");
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.JavaScript/1.2.1/$.uno");
    ::STRINGS[108] = uString::Const("SetExclusive");
    ::STRINGS[109] = uString::Const("setValueWithOrigin");
    ::STRINGS[110] = uString::Const("Failed to set Observable value");
    ::TYPES[2] = ::g::Fuse::Reactive::IObserver_typeof();
    ::TYPES[4] = uObject_typeof()->Array();
    ::TYPES[30] = ::g::Fuse::IArray_typeof();
    ::TYPES[12] = ::g::Fuse::Scripting::ScriptException_typeof();
...
{
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[79/*"clear"*/], uArray::Init<uObject*>(::TYPES[4/*object[]*/], 1, uBox<int>(::TYPES[21/*int*/], _origin)));
}
...
void Observable__Subscription::ReplaceAllExclusive(uObject* newValues)
{
    ...
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[106/*"replaceAllW...*/], uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, sa, uBox<int>(::TYPES[21/*int*/], _origin)));
}
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[107/*"Unexpected ...*/], this, ::STRINGS[5/*"/usr/local/...*/], 830, ::STRINGS[108/*"SetExclusive"*/]);
        return;
    }

    try
    {
        uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[109/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, (uObject*)uPtr(uPtr(_om)->_worker)->Unwrap(newValue), uBox<int>(::TYPES[21/*int*/], _origin)));
    }
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[12/*Fuse.Scripting.ScriptException*/]))
        {
            ::g::Fuse::Scripting::ScriptException* ex = (::g::Fuse::Scripting::ScriptException*)__t.Exception;
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[110/*"Failed to s...*/], ex, this, ::STRINGS[5/*"/usr/local/...*/], 845, ::STRINGS[108/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
...
{
    ::STRINGS[111] = uString::Const("Name table missing 'this' pointer");
    ::STRINGS[112] = uString::Const("this");
    ::TYPES[29] = ::g::Fuse::Reactive::IContext_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::ConstantExpression_type, interface0));
}
...
void This__GetValue_fn(This* __this, uObject* context, uObject** __retval)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::STRINGS[111/*"Name table ...*/]));
}
...
{
    return *__retval = ::STRINGS[112/*"this"*/], void();
}
...
{
    ::STRINGS[113] = uString::Const("Skipped Exception");
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.JavaScript/1.2.1/$.uno");
    ::STRINGS[114] = uString::Const("CheckAndThrow");
    ::STRINGS[115] = uString::Const("JavaScript data model contains circular references or is too deep. Some data may not display correctly.");
    ::STRINGS[116] = uString::Const("CreateMirror");
    ::STRINGS[117] = uString::Const("Cannot use object of type '");
    ::STRINGS[118] = uString::Const("' as 'this' in JavaScript module; must be 'IProperties' or 'App'");
    ::STRINGS[119] = uString::Const("external_object");
    ::STRINGS[120] = uString::Const(" (ScriptClass)");
    ::STRINGS[121] = uString::Const("(function(external_object) { this.external_object = external_object; })");
    ::STRINGS[122] = uString::Const("(set-superclass)");
    ::STRINGS[123] = uString::Const("(function(cl, superclass) { cl.prototype = new superclass(); cl.prototype.constructor = cl; })");
    ::STRINGS[33] = uString::Const(".");
    ::STRINGS[68] = uString::Const(" (ScriptMethod)");
    ::STRINGS[124] = uString::Const("(function(cl, Observable) { cl.prototype.");
    ::STRINGS[125] = uString::Const(" = ");
    ::STRINGS[126] = uString::Const("; })");
    ::STRINGS[127] = uString::Const("ThreadWorked failed");
    ::STRINGS[128] = uString::Const("Run");
    ::STRINGS[129] = uString::Const("Could not create script context");
    ::TYPES[31] = ::g::Uno::Type_typeof();
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[113/*"Skipped Exc...*/], next, this, ::STRINGS[5/*"/usr/local/...*/], 2053, ::STRINGS[114/*"CheckAndThrow"*/]);
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[115/*"JavaScript ...*/], this, ::STRINGS[5/*"/usr/local/...*/], 1623, ::STRINGS[116/*"CreateMirror"*/]);
        return NULL;
    }
...
::g::Fuse::Reactive::ClassInstance* ThreadWorker::GetClassInstance(uObject* obj, ::g::Uno::UX::NameTable* rootTable)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[117/*"Cannot use ...*/], ::g::Uno::Type::FullName(uPtr(::g::Uno::Object::GetType(uPtr(uPtr(rootTable)->This()))))), ::STRINGS[118/*"' as 'this'...*/])));
}
...
uObject* ThreadWorker::Reflect(uObject* obj)
{
    ...
    if (sobj != NULL)
    {
        if (uPtr(sobj)->ContainsKey(::STRINGS[119/*"external_ob...*/]))
        {
            ::g::Fuse::Scripting::External* ext = uAs< ::g::Fuse::Scripting::External*>(uPtr(sobj)->Item(::STRINGS[119/*"external_ob...*/]), ::TYPES[71/*Fuse.Scripting.External*/]);
...
{
    ::g::Fuse::Scripting::Function* cl = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[120/*" (ScriptCla...*/]), ::STRINGS[121/*"(function(e...*/]), ::TYPES[26/*Fuse.Scripting.Function*/]);
    ...
    if (sc->SuperType() != NULL)
    {
        ...
        if (_setSuperclass == NULL)
            _setSuperclass = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::STRINGS[122/*"(set-superc...*/], ::STRINGS[123/*"(function(c...*/]), ::TYPES[26/*Fuse.Scripting.Function*/]);
    ...
    for (int i = 0; i < uPtr(sc->Members())->Length(); i++)
    {
        ...
        {
            ::g::Fuse::Scripting::Function* m = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[33/*"."*/]), uPtr(inlineMethod)->Name), ::STRINGS[68/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[124/*"(function(c...*/], uPtr(inlineMethod)->Name), ::STRINGS[125/*" = "*/]), uPtr(inlineMethod)->Code), ::STRINGS[126/*"; })"*/])), ::TYPES[26/*Fuse.Scripting.Function*/]);
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[127/*"ThreadWorke...*/], e, this, ::STRINGS[5/*"/usr/local/...*/], 1949, ::STRINGS[128/*"Run"*/]);
...
void ThreadWorker::RunInner()
{
...

    {
        ...
        if (ThreadWorker::_context() == NULL)
        {
            ...
            if (ThreadWorker::_context() == NULL)
                U_THROW(::g::Uno::Exception::New2(::STRINGS[129/*"Could not c...*/]));
