...
void CycleState__Seek_fn(CycleState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[6/*"Invalid seek"*/], 0, ::STRINGS[2/*"/usr/local/...*/], 1204);
...
void MasterBase::Register(::g::Fuse::Animations::MixerHandle* handle)
{
    ...
    if (_inactive)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[7/*"Attempt to ...*/], this, ::STRINGS[2/*"/usr/local/...*/], 1832, ::STRINGS[8/*"Register"*/]);
        return;
    }
...
void MixerHandle__Set_fn(MixerHandle* __this, void* value, float* strength)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[13/*"invalid Mix...*/], 0, ::STRINGS[2/*"/usr/local/...*/], 2106);
        return;
    }
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"Resize star...*/], r, ::STRINGS[2/*"/usr/local/...*/], 2957, ::STRINGS[16/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"Resize star...*/], r, ::STRINGS[2/*"/usr/local/...*/], 2965, ::STRINGS[16/*".ctor"*/]);
        _valid = false;
        return;
    }
...
void SpinState__Seek_fn(SpinState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[6/*"Invalid seek"*/], 0, ::STRINGS[2/*"/usr/local/...*/], 3106);
        return *__retval = true, void();
    }
...
void Attract__Subscription::NeedSim(int size)
{
    ...
    if ((size < 0) || (size > 4))
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[18/*"Unexpected ...*/], uBox<int>(::g::Uno::Int_typeof(), size)), this, ::STRINGS[2/*"/usr/local/...*/], 278, ::STRINGS[19/*"NeedSim"*/]);
        return;
    }
...
void TransformAnimatorState__SeekValue_fn(TransformAnimatorState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if ((__this->mixHandle == NULL) || (__this->transform == NULL))
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[6/*"Invalid seek"*/], 0, ::STRINGS[2/*"/usr/local/...*/], 3851);
        return;
    }
