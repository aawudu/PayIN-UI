...
void PlacedArgs::Serialize(uObject* serializer)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[101/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[78/*"y"*/], (double)NewPosition().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[101/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[79/*"width"*/], (double)NewSize().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[101/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[80/*"height"*/], (double)NewSize().Y);
}
...
{
    ::STRINGS[81] = uString::Const("no Action found to remove");
...
void UpdateManager::RemoveAction(uObject* pu, int stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Listeners, NULL, pu))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[81/*"no Action f...*/]));
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[72/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[115/*Fuse.Scripting.ScriptMethod<Fuse.UserEvent>*/], ::STRINGS[82/*"raise"*/], uDelegate::New(::TYPES[116/*Uno.Action<Fuse.Scripting.Context, Fuse.UserEvent, object[]>*/], (void*)UserEvent__raise_fn), 2)));
}

static void UserEvent_build(uType* type)
{
    ::STRINGS[82] = uString::Const("raise");
    ::STRINGS[83] = uString::Const("UserEvent requires a Name");
    ::STRINGS[84] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.2.1/$.uno");
    ::STRINGS[85] = uString::Const("OnRooted");
    ::STRINGS[86] = uString::Const("Raise must be called with zero arguments, or one argument defining the arguments to the event");
    ::STRINGS[87] = uString::Const("Raise must be called with a JavaScript object to define name/value pairs");
    ::STRINGS[88] = uString::Const("Trying to Raise on unrooted UserEvent");
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[83/*"UserEvent r...*/], __this, ::STRINGS[84/*"/usr/local/...*/], 654, ::STRINGS[85/*"OnRooted"*/], NULL);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[88/*"Trying to R...*/], this, ::STRINGS[84/*"/usr/local/...*/], 701, ::STRINGS[89/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[86/*"Raise must ...*/], n, ::STRINGS[84/*"/usr/local/...*/], 421, ::STRINGS[82/*"raise"*/], NULL);
        return;
    }
    ...
    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[87/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[84/*"/usr/local/...*/], 428, ::STRINGS[82/*"raise"*/], NULL);
        return;
    }
...
void UserEventArgs__FuseScriptingIScriptEventSerialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[101/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[90/*"name"*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->Dispatch())->Name()));
...
static void Visual__cctor_1_fn(uType* __type)
{
    ...
    Visual::_isEnabledName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[91/*"IsEnabled"*/]);
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[72/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptProperty1*)::g::Fuse::Scripting::ScriptProperty1::New1(::TYPES[123/*Fuse.Scripting.ScriptProperty<Fuse.Visual, string>*/], ::STRINGS[77/*"Parameter"*/], uDelegate::New(::TYPES[124/*Uno.Func<Fuse.Visual, Uno.UX.Property<string>>*/], (void*)Visual__getParameterProperty_fn), ::STRINGS[92/*".notNull()....*/]), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[125/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[93/*"onParameter...*/], uDelegate::New(::TYPES[126/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__onParameterChanged_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[125/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[94/*"bringIntoView"*/], uDelegate::New(::TYPES[126/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__bringIntoView_fn), 2)));
}

static void Visual_build(uType* type)
{
    ::STRINGS[91] = uString::Const("IsEnabled");
    ::STRINGS[77] = uString::Const("Parameter");
    ::STRINGS[92] = uString::Const(".notNull().parseJson()");
    ::STRINGS[93] = uString::Const("onParameterChanged");
    ::STRINGS[94] = uString::Const("bringIntoView");
    ::STRINGS[95] = uString::Const("index");
    ::STRINGS[96] = uString::Const("Layout was invalidated while performing layout");
    ::STRINGS[97] = uString::Const("Invalid call to RearrangeMarginBox");
    ::TYPES[26] = ::g::Uno::Type_typeof();
    ::TYPES[72] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
...
void Visual::InsertNodesImpl(int index, uObject* items, bool allowMove)
{
    ...
    if ((index < 0) || (index > ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[83/*Uno.Collections.ICollection<Fuse.Node>*/]))))
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New6(::STRINGS[95/*"index"*/]));
...
void Visual::InvalidateLayout(int reason)
{
    if (Visual::_performingLayout())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[96/*"Layout was ...*/]));
...
{
    if (!HasMarginBox())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[97/*"Invalid cal...*/]));
...
{
    ::STRINGS[98] = uString::Const("Invalid RaiseType for event");
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.2.1/$.uno");
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        ...
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[98/*"Invalid Rai...*/], 0, ::STRINGS[3/*"/usr/local/...*/], 1016);
            return;
        }
    }
...
{
    ::STRINGS[99] = uString::Const("visual");
    type->SetInterfaces(
...
void VisualEventArgs::ctor_1(::g::Fuse::Visual* visual)
{
    ...
    if (visual == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[99/*"visual"*/]));
...
{
    ::STRINGS[100] = uString::Const("Wrapped Exception");
    type->SetFields(4);
}
...
{
    ctor_2(::STRINGS[100/*"Wrapped Exc...*/], inner);
}
