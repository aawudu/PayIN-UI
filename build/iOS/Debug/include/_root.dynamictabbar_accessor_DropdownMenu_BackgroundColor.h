...
namespace g{struct dynamictabbar_accessor_DropdownMenu_BackgroundColor;}
...
struct dynamictabbar_accessor_DropdownMenu_BackgroundColor : ::g::Uno::UX::PropertyAccessor
{
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return dynamictabbar_accessor_DropdownMenu_BackgroundColor_typeof()->Init(), _name_; }
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return dynamictabbar_accessor_DropdownMenu_BackgroundColor_typeof()->Init(), Singleton_; }

    void ctor_1();
    static dynamictabbar_accessor_DropdownMenu_BackgroundColor* New1();
};
// }
