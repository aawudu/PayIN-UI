...
namespace g{struct dynamictabbar_FuseLayoutsColumn_Width_Property;}
...
struct dynamictabbar_FuseLayoutsColumn_Width_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Layouts::Column*> _obj;

    void ctor_3(::g::Fuse::Layouts::Column* obj, ::g::Uno::UX::Selector name);
    static dynamictabbar_FuseLayoutsColumn_Width_Property* New1(::g::Fuse::Layouts::Column* obj, ::g::Uno::UX::Selector name);
};
// }
