...
namespace g{struct dynamictabbar_DropdownOption_BackgroundColor_Property;}
...
struct dynamictabbar_DropdownOption_BackgroundColor_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::DropdownOption*> _obj;

    void ctor_3(::g::DropdownOption* obj, ::g::Uno::UX::Selector name);
    static dynamictabbar_DropdownOption_BackgroundColor_Property* New1(::g::DropdownOption* obj, ::g::Uno::UX::Selector name);
};
// }
