...
namespace g{struct dynamictabbar_DropdownMenu_TextColor_Property;}
...
struct dynamictabbar_DropdownMenu_TextColor_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::DropdownMenu*> _obj;

    void ctor_3(::g::DropdownMenu* obj, ::g::Uno::UX::Selector name);
    static dynamictabbar_DropdownMenu_TextColor_Property* New1(::g::DropdownMenu* obj, ::g::Uno::UX::Selector name);
};
// }
