...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.2.1/android/$.uno
// ----------------------------------------------------------------------
...
static void AndroidSurface_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.2.1/android/$.uno");
...
void AndroidSurface__DisposePath_fn(AndroidSurface* __this, ::g::Fuse::Drawing::SurfacePath* path)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[0/*"Duplicate d...*/], path, ::STRINGS[1/*"/usr/local/...*/], 741, ::STRINGS[2/*"DisposePath"*/]);
        return;
    }
...
void AndroidSurface__Prepare_fn(AndroidSurface* __this, ::g::Fuse::Drawing::Brush* brush)
{
    ...
    ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"Unsupported...*/], brush, ::STRINGS[1/*"/usr/local/...*/], 635, ::STRINGS[7/*"Prepare"*/], NULL);
}
...
void AndroidSurface::DrawPath(::g::Java::Object* path, ::g::Fuse::Drawing::Brush* fill, int fillRule, ::g::Java::Object* paint)
{
    ...
    if (linearGradient != NULL)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[3/*"Unprepared ...*/], fill, ::STRINGS[1/*"/usr/local/...*/], 419, ::STRINGS[4/*"DrawPath"*/]);
            return;
        }
    ...
    if (imageFill != NULL)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"Unprepared ...*/], fill, ::STRINGS[1/*"/usr/local/...*/], 435, ::STRINGS[4/*"DrawPath"*/]);
            return;
        }
    ...
    ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"Unsupported...*/], fill, ::STRINGS[1/*"/usr/local/...*/], 456, ::STRINGS[4/*"DrawPath"*/], NULL);
}
...
void AndroidSurface::PrepareImageFill(::g::Fuse::Drawing::ImageFill* fill)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[8/*"Recieved an...*/], uBox(::g::Uno::Int2_typeof(), uPtr(src)->PixelSize()), ::STRINGS[1/*"/usr/local/...*/], 369, ::STRINGS[9/*"PrepareImag...*/], NULL);
        return;
    }
...
static void Brush_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing/1.2.1/$.uno");
    ::STRINGS[7] = uString::Const("Prepare");
    type->SetFields(1,
...
{
    if (!IsPinned())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"Brush is no...*/], this, ::STRINGS[12/*"/usr/local/...*/], 71, ::STRINGS[7/*"Prepare"*/]);
...
static void DrawObjectWatcher_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.2.1/$.uno");
...
void DrawObjectWatcher::Sync()
{
    if (!_rooted)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"Sync while ...*/], this, ::STRINGS[15/*"/usr/local/...*/], 2129, ::STRINGS[16/*"Sync"*/]);
        return;
    }
...
static void Stroke__cctor__fn(uType* __type)
{
    ...
    Stroke::_brushName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[31/*"Brush"*/]);
    Stroke::_colorName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[19/*"Color"*/]);
    Stroke::_widthName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[32/*"Width"*/]);
    Stroke::_offsetName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[18/*"Offset"*/]);
    Stroke::_adjustmentName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[33/*"Adjustment"*/]);
    Stroke::_alignmentName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[34/*"Alignment"*/]);
    Stroke::_lineCapName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[35/*"LineCap"*/]);
    Stroke::_lineJoinName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[36/*"LineJoin"*/]);
    Stroke::_lineJoinMiterLimitName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[37/*"LineJoinMit...*/]);
}

static void Stroke_build(uType* type)
{
    ::STRINGS[13] = uString::Const("Shading");
    ::STRINGS[31] = uString::Const("Brush");
    ::STRINGS[19] = uString::Const("Color");
    ::STRINGS[32] = uString::Const("Width");
    ::STRINGS[18] = uString::Const("Offset");
    ::STRINGS[33] = uString::Const("Adjustment");
    ::STRINGS[34] = uString::Const("Alignment");
    ::STRINGS[35] = uString::Const("LineCap");
    ::STRINGS[36] = uString::Const("LineJoin");
    ::STRINGS[37] = uString::Const("LineJoinMiterLimit");
...
{
    ::STRINGS[38] = uString::Const("GLDraw called with mismatched elements");
    ::STRINGS[15] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.2.1/$.uno");
    ::STRINGS[39] = uString::Const("Draw");
...
void Surface::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* elm, uObject* drawable)
{
    ...
    if (elm != drawable)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[38/*"GLDraw call...*/], this, ::STRINGS[15/*"/usr/local/...*/], 3026, ::STRINGS[39/*"Draw"*/]);
