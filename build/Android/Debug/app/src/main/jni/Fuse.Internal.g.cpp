...
static void MiniList__Enumerator_build(uType* type)
{
    ...
    ::TYPES[12] = ::g::Fuse::Internal::ObjectList__Enumerator_typeof();
    type->SetPrecalc(
    ...
    type->SetFields(0,
        ::TYPES[12/*Fuse.Internal.ObjectList`1.Enumerator*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Internal::MiniList__Enumerator, _iter), 0,
        ::TYPES[11/*Fuse.Internal.MiniList`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Internal::MiniList__Enumerator, _source), 0,
...
static void ObjectList__EnumeratorClass_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[12/*Fuse.Internal.ObjectList`1.Enumerator*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Internal::ObjectList__EnumeratorClass, _en), 0);
}
...
{
    ::TYPES[13] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Internal::AndroidSystemFont__FontDescriptor_typeof(), NULL);
    type->SetFields(0,
        ...
        ::TYPES[13/*Uno.Collections.List<Fuse.Internal.AndroidSystemFont.FontDescriptor>*/], offsetof(::g::Fuse::Internal::AndroidSystemFont__Family, Fonts), 0);
}
...
void AndroidSystemFont__Family::ctor_(uString* name, uString* language, uString* variant)
{
    ...
    Language = language;
    Variant = variant;
    Fonts = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[13/*Uno.Collections.List<Fuse.Internal.AndroidSystemFont.FontDescriptor>*/]));
}
...
{
    ::TYPES[14] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[15] = ::g::Uno::String_typeof()->Array();
    ::TYPES[16] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(5/*SequenceEqual<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[17] = ::g::Uno::Int_typeof();
    ::TYPES[18] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[19] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[20] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    type->SetFields(0,
        ::g::Uno::UX::FileSource_typeof(), offsetof(::g::Fuse::Internal::FontFaceDescriptor, FileSource), 0,
        ::TYPES[17/*int*/], offsetof(::g::Fuse::Internal::FontFaceDescriptor, Index), 0,
        ::TYPES[18/*Uno.Collections.IEnumerable<string>*/], offsetof(::g::Fuse::Internal::FontFaceDescriptor, Styles), 0);
}
...
void FontFaceDescriptor__Equals_fn(FontFaceDescriptor* __this, uObject* o, bool* __retval)
{
    ...
    return *__retval = (((f != NULL) && ::g::Uno::String::op_Equality(uPtr(__this->FileSource)->Name, uPtr(uPtr(f)->FileSource)->Name)) && (__this->Index == uPtr(f)->Index)) && ::g::Uno::Collections::EnumerableExtensions::SequenceEqual(::TYPES[16/*Uno.Collections.EnumerableExtensions.SequenceEqual<string>*/], __this->Styles, uPtr(f)->Styles), void();
}
...
void FontFaceDescriptor__GetHashCode_fn(FontFaceDescriptor* __this, int* __retval)
{
    ...
    hash = (hash * 23) + ::g::Uno::Int::GetHashCode((ind1 = __this->Index, ind1), ::TYPES[17/*int*/]);

    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Styles), ::TYPES[18/*Uno.Collections.IEnumerable<string>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
    {
        uString* s = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[20/*Uno.Collections.IEnumerator<string>*/]), &ret5), ret5);
...
void FontFaceDescriptor::ctor_(::g::Uno::UX::FileSource* fileSource, int index)
{
    ...
    Index = index;
    Styles = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[14/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], uArray::New(::TYPES[15/*string[]*/], 0)));
}
...
static void ImageContainer_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[34/*Uno.Collections.RootableList<Uno.UX.FileSource>*/], offsetof(::g::Fuse::Internal::ImageContainer, _files), 0,
        ...
        ::TYPES[23/*Fuse.Internal.IImageContainerOwner*/], offsetof(::g::Fuse::Internal::ImageContainer, _owner), uFieldFlagsWeak,
        ...
        ::TYPES[30/*Uno.EventHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, ParamChanged1), 0,
        ::TYPES[30/*Uno.EventHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, SourceChanged1), 0,
        ::TYPES[31/*Fuse.Resources.ImageSourceErrorHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, SourceError1), 0);
}
...
void ImageContainer::CreateMultiDensitySource()
{
    ...
    for (uObject* enum4 = (uObject*)uPtr(_files)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum4), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
    {
...
void ImageContainer::File(::g::Uno::UX::FileSource* value)
{
    ...
    if (((::g::Uno::Collections::ICollection::Count(uInterface(uPtr(files), ::TYPES[32/*Uno.Collections.ICollection<Uno.UX.FileSource>*/])) == 0) || (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(files), ::TYPES[32/*Uno.Collections.ICollection<Uno.UX.FileSource>*/])) > 1)) || ((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(files), ::TYPES[33/*Uno.Collections.IList<Uno.UX.FileSource>*/]), uCRef<int>(0), &ret18), ret18) != value))
    {
...
void ImageContainer::ReapplyOptions(::g::Fuse::Resources::ImageSource* src)
{
    ...
    if (mf != NULL)
        ...
        for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(mf)->Sources()), ::TYPES[28/*Uno.Collections.IEnumerable<Fuse.Resources.ImageSource>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
        {
...
static void MiniList_build(uType* type)
{
    ...
    ::TYPES[36] = ::g::Fuse::Internal::ObjectList_typeof();
    type->SetPrecalc(
...
static void ObjectList_build(uType* type)
{
    ...
    ::TYPES[37] = ObjectList__EnumeratorClass_typeof();
    ::TYPES[12] = ObjectList__Enumerator_typeof();
    ::TYPES[38] = uObject_typeof()->Array();
    ::TYPES[39] = ObjectList__Node_typeof();
    type->SetPrecalc(
    ...
    type->SetFields(0,
        ...
        ::TYPES[39/*Fuse.Internal.ObjectList`1.Node*/]->MakeType(type->T(0), NULL)->Array(), offsetof(::g::Fuse::Internal::ObjectList, _nodes), 0,
...
{
    ::TYPES[40] = ::g::Uno::Collections::LinkedList_typeof()->MakeType(::g::Fuse::Internal::SkylineNode_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[40/*Uno.Collections.LinkedList<Fuse.Internal.SkylineNode>*/], offsetof(::g::Fuse::Internal::RectPacker, _skyline), 0,
...
void RectPacker::ctor_(::g::Uno::Int2 size)
{
    ...
    Size(size);
    _skyline = ((::g::Uno::Collections::LinkedList*)::g::Uno::Collections::LinkedList::New1(::TYPES[40/*Uno.Collections.LinkedList<Fuse.Internal.SkylineNode>*/]));
