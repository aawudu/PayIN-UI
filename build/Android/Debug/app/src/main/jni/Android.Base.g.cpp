...
static void JNI_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/UnoCore/1.2.2/targets/android/uno/base/$.uno");
...
{
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, ::STRINGS[2/*"Android.Bas...*/], ::STRINGS[3/*"/usr/local/...*/], 318, uArray::New(::TYPES[1/*object[]*/], 0));
...
{
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, ::STRINGS[2/*"Android.Bas...*/], ::STRINGS[3/*"/usr/local/...*/], 131, uArray::New(::TYPES[1/*object[]*/], 0));
    jclass result;
