...
namespace g{struct dynamictabbar_FuseElementsElement_Alignment_Property;}
...
struct dynamictabbar_FuseElementsElement_Alignment_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Elements::Element*> _obj;

    void ctor_3(::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector name);
    static dynamictabbar_FuseElementsElement_Alignment_Property* New1(::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector name);
};
// }
