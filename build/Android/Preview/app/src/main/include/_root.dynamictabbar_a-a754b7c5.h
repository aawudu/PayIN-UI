...
namespace g{struct dynamictabbar_accessor_DropdownSelectedItem_TextColor;}
...
struct dynamictabbar_accessor_DropdownSelectedItem_TextColor : ::g::Uno::UX::PropertyAccessor
{
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return dynamictabbar_accessor_DropdownSelectedItem_TextColor_typeof()->Init(), _name_; }
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return dynamictabbar_accessor_DropdownSelectedItem_TextColor_typeof()->Init(), Singleton_; }

    void ctor_1();
    static dynamictabbar_accessor_DropdownSelectedItem_TextColor* New1();
};
// }
