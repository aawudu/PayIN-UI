// This file was generated based on /Users/phoenix/Fuse/app_payin/dynamic-tab-bar/build/Android/Preview/cache/ux11/Header.g.uno.
...
static void Header_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Header__New4_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::TextControl_type* Header_typeof()
{
    ...
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("Header", options);
...
void Header__InitializeUX1_fn(Header* __this)
{
...
void Header::InitializeUX1()
{
    uStackFrame __("Header", "InitializeUX()");
    ::g::Fuse::Font* temp = ::g::Fuse::Font::New2(::g::Uno::UX::BundleFileSource::New1(::g::dynamictabbar_bundle::AlegreyaSansBold2b1173ab()));
    TextWrapping(1);
    FontSize(22.0f);
    Margin(::g::Uno::Float4__New2(14.0f, 10.0f, 14.0f, 5.0f));
    Font(temp);
}
