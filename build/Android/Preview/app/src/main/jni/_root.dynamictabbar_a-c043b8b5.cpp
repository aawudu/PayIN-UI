...
{
    uStackFrame __("dynamictabbar_accessor_DropdownMenu_BackgroundColor", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("dynamictabbar_accessor_DropdownMenu_BackgroundColor", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
