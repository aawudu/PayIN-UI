...
{
    uStackFrame __("dynamictabbar_FuseScaling_Factor_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("dynamictabbar_FuseScaling_Factor_Property", "Set(Uno.UX.PropertyObject,float,Uno.UX.IPropertyListener)");
    float v_ = *v;
