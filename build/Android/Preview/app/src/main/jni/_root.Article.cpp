// This file was generated based on /Users/phoenix/Fuse/app_payin/dynamic-tab-bar/build/Android/Preview/cache/ux11/Article.g.uno.
...
// {
// static Article() :4
static void Article__cctor_4_fn(uType* __type)
{
}

static void Article_build(uType* type)
{
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Article__New4_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::TextControl_type* Article_typeof()
{
    ...
    options.ObjectSize = sizeof(Article);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("Article", options);
    type->fp_build_ = Article_build;
    type->fp_ctor_ = (void*)Article__New4_fn;
    type->fp_cctor_ = Article__cctor_4_fn;
...
void Article__InitializeUX1_fn(Article* __this)
{
    __this->InitializeUX1();
}

// public Article New() :8
void Article__New4_fn(Article** __retval)
{
    *__retval = Article::New4();
}

// public Article() [instance] :8
void Article::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void Article::InitializeUX1()
{
    uStackFrame __("Article", "InitializeUX()");
    ::g::Fuse::Font* temp = ::g::Fuse::Font::New2(::g::Uno::UX::BundleFileSource::New1(::g::dynamictabbar_bundle::LatoRegular4c794c7c()));
    TextWrapping(1);
    FontSize(13.0f);
    Margin(::g::Uno::Float4__New2(14.0f, 0.0f, 14.0f, 0.0f));
    Font(temp);
}

// public Article New() [static] :8
Article* Article::New4()
{
    Article* obj1 = (Article*)uNew(Article_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
