// This file was generated based on /Users/phoenix/Fuse/app_payin/dynamic-tab-bar/build/Android/Preview/cache/ux11/Stat.g.uno.
...
// {
// static Stat() :4
static void Stat__cctor_4_fn(uType* __type)
{
}

static void Stat_build(uType* type)
{
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Stat__New4_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::TextControl_type* Stat_typeof()
{
    ...
    options.ObjectSize = sizeof(Stat);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("Stat", options);
    type->fp_build_ = Stat_build;
    type->fp_ctor_ = (void*)Stat__New4_fn;
    type->fp_cctor_ = Stat__cctor_4_fn;
...
void Stat__InitializeUX1_fn(Stat* __this)
{
...
void Stat::InitializeUX1()
{
    uStackFrame __("Stat", "InitializeUX()");
    ::g::Fuse::Font* temp = ::g::Fuse::Font::New2(::g::Uno::UX::BundleFileSource::New1(::g::dynamictabbar_bundle::LatoBoldf136152d()));
    FontSize(15.0f);
    Color(::g::Uno::Float4__New2(0.4784314f, 0.5882353f, 0.6980392f, 1.0f));
    Alignment(8);
    Margin(::g::Uno::Float4__New2(5.0f, 0.0f, 17.0f, 0.0f));
    Font(temp);
}

// public Stat New() [static] :8
Stat* Stat::New4()
{
    Stat* obj1 = (Stat*)uNew(Stat_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
