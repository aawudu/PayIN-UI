...
{
    uStackFrame __("dynamictabbar_accessor_DropdownOption_BackgroundColor", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("dynamictabbar_accessor_DropdownOption_BackgroundColor", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
