// This file was generated based on /Users/phoenix/Fuse/app_payin/dynamic-tab-bar/build/Android/Preview/cache/ux11/ColorPalette.g.uno.
...
static void ColorPalette_build(uType* type)
{
    ...
    type->Reflection.SetFields(5,
        new uField("color0", 110),
        new uField("color1", 111),
        new uField("color2", 112),
        new uField("color3", 113),
        new uField("color4", 114));
