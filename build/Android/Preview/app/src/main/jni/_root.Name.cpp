// This file was generated based on /Users/phoenix/Fuse/app_payin/dynamic-tab-bar/build/Android/Preview/cache/ux11/Name.g.uno.
...
static void Name_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Name__New4_fn, 0, true, type, 0));
}
...
{
    uStackFrame __("Name", "InitializeUX()");
    ::g::Fuse::Font* temp = ::g::Fuse::Font::New2(::g::Uno::UX::BundleFileSource::New1(::g::dynamictabbar_bundle::RobotoBold54af5bfa()));
    FontSize(15.0f);
    Font(temp);
}
