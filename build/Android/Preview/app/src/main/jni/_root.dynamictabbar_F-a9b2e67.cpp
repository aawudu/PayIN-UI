...
{
    uStackFrame __("dynamictabbar_FuseTranslation_Y_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("dynamictabbar_FuseTranslation_Y_Property", "Set(Uno.UX.PropertyObject,float,Uno.UX.IPropertyListener)");
    float v_ = *v;
